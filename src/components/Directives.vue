...
<template>
    ...
    <div 
    class="bg-blue-400 text-white rounded py-1 px-2"
    :class="{'bg-orange-500':isChecked }"
    >
        Este es un mensaje
    </div>
    <div v-show="isChecked">
        Este es un mensaje que podria ocultar
    </div>
    <div v-if="false">
        Este es un mensaje que podria ocultar
    </div>
    <div v-else>
        Esto se ve porque no cumplio la condicion del if 
    </div>
</template>